<html>
    <head>
        <meta charset="utf-8">
        <title>Registro de Empresas Farmaceuticas iNeed</title>
    	...
    	<div class="row">
            <div class="col-sm-7">
		    	<div class="divider-new">
		            <h2 class="h2-responsive">Gestion Empresas Farmaceuticas</h2>
		        </div>
        	</div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-4">
                <form id="form-empresa">
                    ...
                    <input type="submit" class="form-control" name="boton-enviar-empresa" value="Crear Empresa" id="boton-enviar-empresa">
                </form>
            </div>
        </div>    
