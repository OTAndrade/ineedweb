...
<html>
    <head>
        <meta charset="utf-8">
        <title>Registro de Usuarios de Farmacias iNeed</title>
		    ...
		    <div class="row">
		        <div class="col-md-4">
		        	...
		        	<div class="card" style="width: 35rem;">
						  <img class="img-rounded" src="<?= $farmacia['Logo'] ?>" alt="User profile picture">
						  <div class="card-body">
						    <h5 class="card-title"><?= $farmacia['Nombre'] ?></h5>
						    <p class="card-text"><?= $farmacia['Sigla'] ?></p>
						  </div>
						  <ul class="list-group list-group-flush">
						  	<li class="list-group-item">Direccion: <?= $farmacia['Direccion'] ?></li>
						  	<li class="list-group-item">Telefono: <?= $farmacia['Telefono'] ?></li>
						  	<li class="list-group-item">Mail: <?= $farmacia['Mail'] ?></li>
						  	<li class="list-group-item">www: <?= $farmacia['Web'] ?></li>
						  	<li class="list-group-item">Facebook: <?= $farmacia['Facebook'] ?></li>
						  	<li class="list-group-item">Twitter: <?= $farmacia['Twitter'] ?></li>
						  </ul>
						  <div class="card-body">
						    <p><?= Html::a('Logo', ['site/uploadfarmacia', 'far' => $far],['class' => 'btn btn-warning']); ?></p>
						    <p><?= Html::a('Volver', ['site/farmacias'],['class' => 'btn btn-info']); ?></p>
						  </div>
					</div>
			            ...
			            <div class="col-md-3">
					        <form id="form-asociados">
		                        ...
		                        <div class="form-group">
		                            ...
		                            <input type="hidden" class="form-control" name="tipoUsuario" value="FARMACIA" id="tipoUsuario">
		                            <input type="hidden" class="form-control" name="id_empresa" value="<?= $far ?>" id="id_empresa">
		                            <input type="hidden" class="form-control" name="nombre_empresa" value="<?= $farmacia['Nombre'] ?>" id="nombre_empresa">
		                        </div>
					            <div class="row">    
